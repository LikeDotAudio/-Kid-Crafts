...
This repository contains various HTML-based crafts and applications.

## Crafts

*   **Bingo Game**: A web-based implementation of the Bingo game.
    *   [Play Bingo](bingo/bingo.index.htm)
*   **Bingo Card Generator**: A tool to create custom Bingo cards.
    *   [Create Bingo Cards](BingoCard/BingoCard.index.htm)
*   **Coaster Project**: Contains files related to a coaster-themed project.
